...
import io.github.toberocat.versions.v1_19.NMSLoader_1_19;
...
public class NMSFactory {
     ...
     */
    public static String[] versions = new String[]{"1.19", "1.18", "1.17", "1.16", "1.15", "1.14", "1.13"};

    public static NMSInterface create_1_19() {
        return new NMSLoader_1_19();
    }
